...
/**
 * Created by reve99 on 4/26/2016.
 */
public class ProductControllerTest {
    ...
    public void testList() throws Exception{
        ...
        mockMvc.perform(get("/product/list")).andExpect(status().isOk()).andExpect(view().name("product/list")).andExpect(model().attribute("products",hasSize(2)));
